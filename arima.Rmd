...
```{r}
raw_data <- read.csv("PJME_hourly.csv")
...
accuracy(prog)
fit <- auto.arima(tomodel, stepwise=TRUE, nmodels=10) #max 10 modeli bo zajmuje bardzo dużo czasu
checkresiduals(fit)
```
...
autoplot(fcast) + ylab("Energy Consumption (MW)")
```
